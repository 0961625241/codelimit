...
contract BogOrderRouter {
    ...
    address public constant WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
 ...
 * 
 */
contract BogLimitOrdersV1 is  IBogLimitOrdersV1 {
    using SafeMath for uint256;
    ...
    // IPancakeRouter02 public constant router = IPancakeRouter02(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f);
    // address public constant WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    // // address constant BUSD = 0xad6d458402f60fd3bd25163575031acdce07538d;
    ...
    // }
       constructor(address _factory, address _WBNB, address _dai) {
        factory = _factory;
        WBNB = _WBNB;
        DAI = _dai;
         bogRouter = new BogOrderRouter();
    ...
    function placeBNBTokenOrder(address tokenOut, uint256 targetAmountOut, uint256 minAmountOut) external payable override {
        createOrder(msg.sender, OrderType.BNB_TOKEN, WBNB, tokenOut, msg.value, targetAmountOut, minAmountOut);
    }
    ...
    function placeBNBTokenOrderFor(address owner, address tokenOut, uint256 targetAmountOut, uint256 minAmountOut) external payable {
        createOrder(owner, OrderType.BNB_TOKEN, WBNB, tokenOut, msg.value, targetAmountOut, minAmountOut);
    }
    ...
    function placeTokenTokenOrder(address tokenIn, uint256 amountIn, address tokenOut, uint256 targetAmountOut, uint256 minAmountOut) external override {
        ...
        createOrder(msg.sender, OrderType.BNB_TOKEN, WBNB, tokenOut, amountIn, targetAmountOut, minAmountOut);
    }
    ...
    function placeTokenBNBOrder(address tokenIn, uint256 amountIn, uint256 targetAmountOut, uint256 minAmountOut) external override {
        ...
        createOrder(msg.sender, OrderType.TOKEN_BNB, tokenIn, WBNB, amountIn, targetAmountOut, minAmountOut);
    }
    ...
    function cancelOrder(uint256 orderID) external override {
        ...
        require(msg.sender == ord.owner || ord.timestamp + ORDER_EXPIRY >= block.timestamp , "You are not authorized to cancel this order.");
